    ...
    *,
    ...
    if industry_id == "hydro":
        ...
        assumptions = [
            ...
            "最新已实施财年现金分红按更高目标股息率折现，检验高股息在周期下行时是否仍有支撑",
        ...
        assumptions = [
            ...
            "最新已实施财年分红按压力目标股息率形成第二估值锚，检验基础分红可持续性",
        ...
        assumptions = [
            ...
            "最新已实施财年现金分红按压力目标股息率形成重要估值锚，现金转换和债务决定其可信度",
        ...
        assumptions = [
            ...
            "最新已实施财年分红是重要估值锚，但经营现金流尚未扣资本开支，不能直接等同自由现金流",
        ...
        assumptions = [
            "以当前价/PE反推EPS TTM，再施加情景盈利变化",
            "目标PE由当前PE、五年估值分位和自动质量分共同调整",
            "最新已实施财年现金分红只作为辅助锚，主要价值仍来自盈利与现金流",
